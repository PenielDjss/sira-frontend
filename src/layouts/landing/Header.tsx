    ...
    <header className="sticky top-0 z-50 flex justify-between items-center border-b w-full py-3 px-8 bg-background">
      ...
      <nav className="hidden lg:flex items-center gap-1">
        ...
        >
          <Button
            variant="link"
            className="inline-flex items-center gap-1.5 text-sm font-medium text-foreground/70 hover:text-foreground transition-colors px-3 py-2 rounded-md hover:no-underline"
          >
            Templates
            <ChevronDown
